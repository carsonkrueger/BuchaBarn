...
export default () => {
  const [faqList, setFaqList] = useState([
    ...
    },
    {
      ...
      answer:
        "All fermented foods create trace amounts of ethanol in the fermentation process. Ethanol is part of the natural preservation of the fermented food. To ensure KidBucha is safe, we do not over-ferment, we do not do a 2nd fermentation, we remove most of the yeast prior to bottling, alcohol test each batch and immediately refrigerate once flavored to slow the fermentation process down to a halt. KidBucha must remain cold until ready to drink to maintain stability. The organic concentrated vinegar powder that is added as a natural preservative, may inhibit further fermentation of the yeast that may be left behind.",
    },
    {
